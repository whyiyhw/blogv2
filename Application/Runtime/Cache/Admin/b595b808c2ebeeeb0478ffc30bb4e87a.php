...
<script type="text/javascript" src="/Public/Huilib/respond.min.js"></script>
<![endif]-->
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"><span class="logo navbar-slogan f-l mr-10 hidden-xs" style="font-size: 20px">YI+</span>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li><span id="clean" style="margin: 6px 10px 0 0;" class="btn btn-success">清除缓存</span></li>
				<li>超级管理员</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
        <dl id="menu-blog">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('Article/index');?>" data-title="博文管理" href="javascript:void(0)">博文管理</a></li>
					<li><a data-href="<?php echo U('Category/index');?>" data-title="分类管理" href="javascript:void(0)">博文分类</a></li>
					<li><a data-href="<?php echo U('Email/index');?>" data-title="定时邮件管理" href="javascript:void(0)">定时邮件管理</a></li>
                </ul>
            </dd>
        </dl>
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="article-list.html" data-title="资讯管理" href="javascript:void(0)">自己</a></li>
			    </ul>
		    </dd>
	    </dl>
		<dl id="menu-picture">
		...
		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe621;</i> 杂七杂八<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="http://h-ui.duoshuo.com/admin/" data-title="评论列表" href="javascript:;">小脚本</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
