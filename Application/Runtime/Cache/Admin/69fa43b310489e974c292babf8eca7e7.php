...
<div class="page-container">
	<p class="f-20 text-success"><span class="f-14">YI+</span>&nbsp博客&图片后台管理</p>
	<p>登录次数：<?php echo ($times); ?> </p>
	<p>上次登录IP：<?php echo ($last["login_ip"]); ?>   上次登录时间：<?php echo (date('Y-m-d H:i:s',$last["login_time"])); ?></p>
	<p>本次登录IP：<?php echo ($first["login_ip"]); ?>  本次登录时间：<?php echo (date('Y-m-d H:i:s',$first["login_time"])); ?></p>
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th colspan="7" scope="col">信息统计(暂时不写,写完其它功能再补充)</th>
			</tr>
			<tr class="text-c">
				<th>统计</th>
				<th>资讯库</th>
