...
<head>
    ...
    <![endif]-->
    <title>博文列表</title>
    <link rel="stylesheet" href="/Public/Hui/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
</head>
<body class="pos-r">
...
<div>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a class="btn btn-primary radius" onclick="product_add('新增博文','<?php echo U('Admin/Article/add');?>')" href="javascript:;">
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <tbody>
                <?php if(is_array($data['date'])): $i = 0; $__LIST__ = $data['date'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><tr class="text-c va-m">
                        <td><input name="" type="checkbox" value=""></td>
                        <td><?php echo ($key+1); ?></td>
                        <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['id']) == $cat["c_id"]): ?><td><?php echo ($vo["c_name"]); ?></td><?php endif; endforeach; endif; else: echo "" ;endif; ?>

                        <td><?php echo ($cat["a_name"]); ?></td>
                        <td><?php echo (date('Y-m-d H:i:s',$cat["a_publishtime"])); ?></td>
                        <td>12</td>
                        <td class="td-status"><?php echo ($cat["a_status"]); ?></td>
                        <td class="td-manage">
                            <a class="btn btn-danger radius" href="<?php echo U('del','id='.$cat['id']);?>"
                               onclick="return confirm('是否删除文章：<?php echo ($cat["a_name"]); ?>?');">删除</a>
                            <a class="btn btn-primary radius" href="<?php echo U('edit','id='.$cat['id']);?>">编辑</a>
                        </td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                    <!--<td>-->
                        <!--<a onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;">-->
                            <!--<img width="60" class="product-thumb" src="/Public/Hui/temp/product/Thumb/6204.jpg">-->
                        <!--</a>-->
                    <!--</td>-->
                    <!--<td class="text-l">-->
                        <!--<a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;">-->
                            <!--<img title="国内品牌" src="/Public/Hui/static/h-ui.admin/images/cn.gif">-->
                                <!--<b class="text-success">圣象</b>-->
                            <!--哥本哈根橡木地板KS8373-->
                        <!--</a>-->
                    <!--</td>-->
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/Public/Hui/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script>
<script type="text/javascript" src="/Public/Hui/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="/Public/Hui/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
